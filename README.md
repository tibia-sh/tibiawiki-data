...
release of it wrote them. From `3.1.0` that is `9.0.0+tibiash.1`, a release of tibia.sh's copy.
Earlier releases say `9.0.0`, the upstream release.
...
generated by tibia.sh's copy of [tibiawiki-sql](https://github.com/tibia-sh/tibiawiki-sql), release
`v9.0.0+tibiash.1`. That copy is based on
[tibiawiki-sql](https://github.com/Galarzaa90/tibiawiki-sql) by Allan Galarza, the original project.
