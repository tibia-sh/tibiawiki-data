 ...
 * server cannot read. Until that contract is settled, the generator the shipped index
 * was built with is pinned here as a literal. A rebuild with any other generator fails
 * this test and cannot publish, which turns a generator change into a decision someone
 * makes rather than a side effect of the next refresh.
 */
